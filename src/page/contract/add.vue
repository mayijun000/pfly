			...
			<el-col :span="24">
				<el-card style="width: 1000px;margin: 0 auto;">
					<el-form :rules="rules" :model="formData" ref="formData" label-width="300px" class="demo-formData">
						...
						<el-form-item label="卖方" prop="loginName">
						...
						<el-form-item label="签订地点" prop="deliverySignAdrrId">
						...
						<el-form-item label="上传合同附件" prop="imgSrc">
...
<script>
	...
	import { getClassification, getContractSave, queryProductExistence, getMemberSelect,getCityList } from '@/api/getData';
	export default {
		data() {
		...
		methods: {
			...
			removeAddr(item) {
				var index = this.addrList.indexOf(item);
				if(index !== -1) {
			...
			showUploadContent() {
				if(this.uploadForm.content.path) {
					...
					this.imgSrc = "http://image.pfxzqy.com/" + this.uploadForm.content.path;
				}
			}
		},
		watch: {
