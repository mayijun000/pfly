				...
				<el-card style="width:500px;margin: 0 auto;">
					<el-form label-width="140px" :label-position="labelPosition" :model="formData" ref="formData" :rules="rules">
						...
						<el-form-item label="城市">
							<el-select style="width:123px" prop="cityId" v-model="formData.cityId" @visible-change="selectChange" placeholder="请选择省">
								<el-option v-for="item in educationData" :key="item.placeId" :label="item.placeName" :value="item.placeId">
								</el-option>
							</el-select>
							<el-select style="width:123px" prop="countyId" v-model="formData.countyId" placeholder="请选择市">
