		...
		<el-row>
			<el-col :span="24">
				<el-card style="width:800px;margin: 0 auto;padding-bottom: 10px;">
					<header class="contractTitle">客户详情</header>
					<ul class="contractBody">
						<li>
							<span class="bodyLabel">统一社会信用代码: </span><span>{{formData.licenseCode}}</span>
							<span class="bodyLabel">企业简称: </span><span>{{formData.shortName}}</span>

						</li>
						<li>
							<span class="bodyLabel">企业名称: </span><span>{{formData.name}}</span>
