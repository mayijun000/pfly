<template>
	<section>
		<el-row>
			<el-col :span="24">
				<el-card style="text-align: center;width:1000px;margin: 0 auto;">
					<el-form style="width:90%;margin: 0 auto;" label-width="200px" :inline="true" :model="chanceForm" ref="chanceForm" :rules="rules">
						<el-form-item label="企业客户" style="margin-left: -150px;">
							...
							<el-button type="primary" @click="toCustomer">一键维护客户</el-button>
						</el-form-item>
						<el-form-item label="项目名称" prop="projectName">
							<el-input style="width:295px" v-model="chanceForm.projectName"></el-input>
						</el-form-item>
						<el-form-item label="发布时间" prop="publishDate" style="margin-left: -150px;">
							<el-date-picker style="width:270px" v-model="chanceForm.publishDate" type="date" placeholder="选择日期">
							</el-date-picker>
						</el-form-item>
						...
						<el-form-item label="招标正文" style="margin-left: -150px;" prop="content">
							<div class="edit_container">
								<quill-editor v-model="chanceForm.content" ref="myQuillEditor" class="editer" :options="editorOption">
								</quill-editor>
							</div>
						</el-form-item>
					</el-form>
...
<script>
	...
	import { getChanceSave, getMemberSelect } from '@/api/getData'
	export default {
		data() {
			return {
				customerList: [],
