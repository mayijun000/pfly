				...
				<el-card style="width:1000px;margin: 0 auto;">
					<el-form :model="formData" ref="formData" :rules="rules" label-width="300px" class="demo-formData">
						...
						<el-form-item label="采购方">
							<span v-model="formData.demandName" style="width:200px;display: block;">{{formData.demand}}</span>
						</el-form-item>
						<el-form-item label="供应商">
							<span v-model="formData.supplierName" style="width:200px;display: block;">{{formData.supplier}}</span>
						</el-form-item>
			...
			async getOrderInfoData() {
				try {
					...
					if(returnData.result == "success") {
						...
						this.formData.supplierName = item._supplier;
						this.formData.demandName = item._demand;
