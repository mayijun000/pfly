		...
		<el-row>
			<el-col :span="24">
				...
				<el-table :data="tableData" border stripe style="width: 100%">
					...
					<el-table-column prop="_wareId" label="仓库">
					</el-table-column>
					<el-table-column prop="name" label="产品名称" min-width="100">
					</el-table-column>
					<el-table-column prop="material" label="材质">
					</el-table-column>
					<el-table-column prop="specifiModel" label="规格型号" min-width="100">
					</el-table-column>
					<el-table-column prop="createDate" label="入库时间" min-width="110">
					</el-table-column>
					<el-table-column prop="number" label="入库数量(吨)" min-width="100">
					</el-table-column>
					...
					<el-table-column label="操作" width="80">
						<template scope="scope">
							<el-button size="small" type="warning" @click="detail(scope.row)">调整</el-button>
						</template>
					</el-table-column>
				</el-table>
				<div class="block">
