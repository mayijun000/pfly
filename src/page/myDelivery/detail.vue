			...
			<el-col :span="24">
				<el-card style="width: 1000px;margin: 0 auto;">
					...
					<ul class="contractBody">
						<li>
							<span class="bodyLabel">发货编号：</span><span>{{formData.deliveryNum}}</span>
						...
						<li>
							...
							<span class="bodyLabel">收货地址：</span><span>{{formData.addressId}}</span>
						</li>
						<li>
						...
						<li>
							<span class="bodyLabel">实发总量(吨)：</span><span>{{formData.deliveryNumber}}</span>
							<span class="bodyLabel">签收总量(吨)：</span><span>{{formData.receiptNumber}}</span>
						</li>
					</ul>
					<el-table :data="formData.itemList" style="width:100%;" align="center">
						...
						<el-table-column label="实发量(吨)" prop="itemRealDeliveryNumber">
						</el-table-column>
