<template>
	...
	<section>
		<el-row>
			<el-col :span="24">
				<div class="tableTitle">物流管理列表</div>
				<el-form :model="findForm" :inline="true" class="demo-form-inline">
					<el-form-item label="物流公司名称">
						<el-input placeholder="物流公司名称" v-model="findForm.name"></el-input>
					</el-form-item>
				...
				<el-table :data="tableData" border stripe style="width: 100%">
					<el-table-column prop="companyCode" label="物流公司编号">
					</el-table-column>
					<el-table-column prop="shortName" label="物流公司简称">
					</el-table-column>
