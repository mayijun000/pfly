		...
		<el-row>
			<el-col :span="24">
				<el-card style="width:800px;margin: 0 auto;padding-bottom: 10px;">
					<header class="contractTitle">物流公司详情</header>
					<ul class="contractBody">
						<li>
							<span class="bodyLabel">统一社会信用代码: </span><span>{{formData.licenseCode}}</span>
							<span class="bodyLabel">物流公司简称: </span><span>{{formData.shortName}}</span>

						</li>
						<li>
							<span class="bodyLabel">物流公司名称: </span><span>{{formData.name}}</span>
